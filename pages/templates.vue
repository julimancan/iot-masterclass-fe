        ...
        <div class="row">
          ...
          <div class="col-6">
            ...
            <div v-if="widgetType === 'numberchart'">
              ...
              <base-input v-model="iotNumberChartConfig.unit" label="Unit" type="text">
              </base-input>
              ...
              <base-input
                v-model.number="iotNumberChartConfig.chartTimeAgo"
            ...
            <div v-if="widgetType === 'button'">
              <base-input
                v-model="iotConfigButton.variableFullName"
                label="Var Name"
                type="text"
              >
              </base-input>
              ...
              <base-input
                v-model="iotConfigButton.message"
              ...
              <el-select
                v-model="iotConfigButton.column"
                class="select-success"
                placeholder="Select Column Width"
                style="width: 100%"
              >
...
import RealTimeNumberChart from "../components/Widgets/RealTimeNumberChart.vue";
  ...
  methods: {
    addNewWidget() {
      if (this.widgetType === "numberchart") {
        ...
        this.widgets.push(JSON.parse(JSON.stringify(this.iotNumberChartConfig)));
      }
      ...
      if (this.widgetType === "button") {
        this.iotConfigButton.variable = this.makeId(10);
        this.widgets.push(JSON.parse(JSON.stringify(this.iotConfigButton)));
      }
